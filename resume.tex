...
% Sections formatting
\titleformat{\section}{ \vspace{-6pt} \ttfamily \centering \large}{}{0em}{}[\color{black}\titlerule{} \vspace{-6pt}]
...
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
	...
	\href{mailto:sachinjiyer@gmail.com}{sachinjiyer@gmail.com } -  \href{https://keyserver.ubuntu.com/pks/lookup?op=hget&search=dc0b988ca23a9d9e46ee4b355887e8f9}{ubuntu keyserver}
...
{Created a container that utilized Lua JIT with NGINX to sync git repos as an alternative to git-sync}
...
{Created a website that does real time client-side 3d rendering, as well as \href{https://github.com/sachiniyer/cheap_portable_k3s\#applications}{self-deployed services}. Deployed on \href{https://github.com/sachiniyer/cheap_portable_k3s/blob/main/README.pdf}{k3s} with full CI/CD using \href{https://github.com/kubernetes/git-sync}{git-sync}.}
