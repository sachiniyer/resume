...
\resumeSubHeadingListStart{}
\resumeItem{Langs}
{Typescript, Javascript, Node, C++, C, Rust, Java, Python, \href{https://github.com/sachiniyer/emacs/blob/old-config/.emacs}{(e)Lisp}, Bash/Zsh, MDown, JSON, \href{https://github.com/sachiniyer/control_display/blob/main/control_display_site/deployment.yaml}{YAML}, \LaTeX} % chktex 36
\resumeItem{Tech}
