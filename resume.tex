...
{Bachelors of Science in Computer Science}{Sep 2020 - Exp. May 2023}
...
\resumeItem{\href{https://dev.hsrn.nyu.edu/hsrn-projects/mediastorage/}{Parallel File System}}
{Prototyped filesystems for 6TB storage cluster for usage internally and externally to the HSRN}
\resumeItem{\href{https://dev.hpc.nyu.edu/corelink/corelink-client/}{Client Development}}
{Developed a Bash client, and worked on Python, C++, and Javascript clients for \href{https://corelink.hsrn.nyu.edu/}{Corelink}.}
\resumeItem{\href{https://dev.hpc.nyu.edu/corelink/corelink-examples}{Audio Video Conferencing}}
{Created an audio/video service in C++ that interfaces with the \href{https://corelink.hsrn.nyu.edu/}{Corelink} network.}
\resumeItem{\href{https://dev.hpc.nyu.edu/corelink/corelink-documentation/-/pipelines}{CI/CD}}
{Developed documentation, testing, and linting pipelines for the project in \href{https://dev.hsrn.nyu.edu/}{Gitlab}.}
\resumeItemListEnd
...
{Estimated bandwidth using \href{https://en.wikipedia.org/wiki/Autoregressive_integrated_moving_average}{Auto ARIMA} and \href{https://facebook.github.io/prophet/}{other time series ML algorithms}.}
\resumeItemListEnd
\resumeSubHeadingListEnd
