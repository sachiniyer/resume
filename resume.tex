...
{Created a web crawling service to notify when there is a delivery slot available for Whole Foods, Costco, or Safeway. Used AWS SNS, ECS,  and Lambda functions. Created Docker containers headless Chrome instances running Selenium.}
